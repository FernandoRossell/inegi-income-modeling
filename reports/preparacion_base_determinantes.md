...
Método de ejecución registrado: notebook_12_ejecutado_proceso_python_limpio_sin_nbclient.
...
- `reports/figures/preparacion_determinantes/target_hist_original_log.png`: El panel original limita el eje x a P99 solo para lectura visual; no recorta datos.
- `reports/figures/preparacion_determinantes/target_log_por_region.png`: Boxplot descriptivo no ponderado; outliers ocultos solo en la figura para legibilidad.
- `reports/figures/preparacion_determinantes/target_log_por_sexo.png`: Boxplot descriptivo no ponderado; outliers ocultos solo en la figura para legibilidad.
- `reports/figures/preparacion_determinantes/target_log_por_escolaridad.png`: Boxplot descriptivo no ponderado; outliers ocultos solo en la figura para legibilidad.
